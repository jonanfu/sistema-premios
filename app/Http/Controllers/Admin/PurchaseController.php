...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('adminlte.purchase.index', compact('purchases'));
    }
    ...
    public function create()
    {
        ...
        return view('adminlte.purchase.create', compact('providers', 'products'));
    }
    ...
    public function show(Purchase $purchase)
    {
        ...
        return view('adminlte.purchase.show', compact('purchase', 'purchaseDetails', 'subtotal'));
    }
    ...
    {
        $providers = Provider::get();
        return view('adminlte.purchase.edit', compact('purchase'));
    }
