            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" name="name" id="name" value="{{$client->names}}" aria-describedby="helpId" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="cedula">CEDULA</label>
                        <input type="number"
                          class="form-control" name="cedula" id="cedula" value="{{$client->cedula}}" aria-describedby="helpId" required>
                    </div>
